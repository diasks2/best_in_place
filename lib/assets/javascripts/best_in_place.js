...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.dblClick          = self.dblClick          || $parent.attr("data-dbl-click");
      ...
      self.inner_id          = self.inner_id          || $parent.attr("data-inner-id");
    ...
    self.dblClick          = self.element.attr("data-dbl-click")           || self.dblClick;
    ...
    self.inner_id          = self.element.attr("data-inner-id")            || self.inner_id   || null;
  ...
  "input" : {
    activateForm : function() {
      ...
      if(this.inner_id !== null) {
        input_elt.attr('id', this.inner_id);
      }
